...
## Methodology
The project applies machine learning algorithms and optimization techniques, such as the Travelling Salesman Problem (TSP) and Simulated Annealing Algorithm to find the most efficient routes.
